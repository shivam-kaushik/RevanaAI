...
class SQLGenerationAgent:
    ...
    def generate_sql(self, user_query, active_table=None):
        ...
        try:
            ...
            - Always use to_timestamp(date_column, 'MM/DD/YYYY HH24:MI')::DATE for date operations
            - For date filtering, use BETWEEN 'YYYY-MM-DD' AND 'YYYY-MM-DD'
            ...
            - Example: SELECT to_timestamp(invoicedate, 'MM/DD/YYYY HH24:MI')::DATE AS invoice_date, SUM(quantity) FROM table GROUP BY invoice_date ORDER BY invoice_date
            ...
            # Post-process to fix common date format issues
